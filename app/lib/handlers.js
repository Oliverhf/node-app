...
handlers.index = function (data, callback) {
  ...
  if (data.method == "get") {
    ...
    var templateData = {
      ...
      "head.description":
        "We offer free, simple uptime monitoring for HTTP/HTTPS sites of all kinds. When your site goes down, we will send you a text to let you know",
      "body.class": "index",
    };
...
handlers.favicon = function (data, callback) {
  ...
  if (data.method == "get") {
    ...
    helpers.getStaticAsset("favicon.icon", function (err, data) {
      if (!err && data) {
        // Callback the data
    ...
    _data.read("users", phone, function (err, userData) {
      ...
      if (!err && userData) {
        ...
        if (hashedPassword == userData.hashedPassword) {
          ...
          _performance.mark('creatng data for token');
          ...
          _data.create("tokens", tokenId, tokenObject, function (err) {
            ...
            _performance.measure('Password hashing', 'beginning passowrd hashing', 'password hashing complete');
